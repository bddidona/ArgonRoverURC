// Generated by gencpp from file rover_manual/vesc_state.msg
// DO NOT EDIT!


#ifndef ROVER_MANUAL_MESSAGE_VESC_STATE_H
#define ROVER_MANUAL_MESSAGE_VESC_STATE_H
...
struct vesc_state_
{
  typedef vesc_state_<ContainerAllocator> Type;
  ...
  vesc_state_(const ContainerAllocator& _alloc)
    : voltage_input(0.0)
    , temperature_pcb(0.0)
    , current_motor(0.0)
    , current_input(0.0)
  ...
  typedef boost::shared_ptr< ::rover_manual::vesc_state_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rover_manual::vesc_state_<ContainerAllocator> const> ConstPtr;

}; // struct vesc_state_

typedef ::rover_manual::vesc_state_<std::allocator<void> > vesc_state;

typedef boost::shared_ptr< ::rover_manual::vesc_state > vesc_statePtr;
typedef boost::shared_ptr< ::rover_manual::vesc_state const> vesc_stateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rover_manual::vesc_state_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rover_manual::vesc_state_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::rover_manual::vesc_state_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rover_manual::vesc_state_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rover_manual::vesc_state_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rover_manual::vesc_state_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rover_manual::vesc_state_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rover_manual::vesc_state_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rover_manual::vesc_state_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rover_manual::vesc_state_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x81214bb4c1945e7cULL;
  static const uint64_t static_value2 = 0x159bd76ec397ac04ULL;
};

template<class ContainerAllocator>
struct DataType< ::rover_manual::vesc_state_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::rover_manual::vesc_state_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rover_manual::vesc_state_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rover_manual::vesc_state_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rover_manual::vesc_state_<ContainerAllocator>& v)
  {
...
#endif // ROVER_MANUAL_MESSAGE_VESC_STATE_H
