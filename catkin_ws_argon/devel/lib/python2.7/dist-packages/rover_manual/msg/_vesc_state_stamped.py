...
"""autogenerated by genpy from rover_manual/vesc_state_stamped.msg. Do not edit."""
import sys
...
class vesc_state_stamped(genpy.Message):
  _md5sum = "3a2b3a0e5b5f10ce6bbf973d767cdc4d"
  _type = "rover_manual/vesc_state_stamped"
...
"""
  ...
  _slot_types = ['std_msgs/Header','rover_manual/vesc_state']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(vesc_state_stamped, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.state is None:
        self.state = rover_manual.msg.vesc_state()
    else:
      self.header = std_msgs.msg.Header()
      self.state = rover_manual.msg.vesc_state()
