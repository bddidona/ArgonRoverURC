...
class vesc_state_stamped {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = vesc_state.serialize(obj.state, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new vesc_state_stamped(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [state]
    data.state = vesc_state.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new vesc_state_stamped(null);
    ...
    if (msg.state !== undefined) {
      resolved.state = vesc_state.Resolve(msg.state)
    }
    else {
      resolved.state = new vesc_state()
    }
...
module.exports = vesc_state_stamped;
