...
(cl:defmethod cl:initialize-instance :after ((m <obstacle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'obstacle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name yeti_snowplow-msg:<obstacle> is deprecated: use yeti_snowplow-msg:obstacle instead.")))
...
(cl:defmethod r-val ((m <obstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yeti_snowplow-msg:r-val is deprecated.  Use yeti_snowplow-msg:r instead.")
  (r m))

(cl:ensure-generic-function 'dynamic-val :lambda-list '(m))
(cl:defmethod dynamic-val ((m <obstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yeti_snowplow-msg:dynamic-val is deprecated.  Use yeti_snowplow-msg:dynamic instead.")
  (dynamic m))
