...
(cl:defclass <target> (roslisp-msg-protocol:ros-message)
  ((dir
   ...
   (location
    :reader location
    :initarg :location
    :type yeti_snowplow-msg:location_point
    :initform (cl:make-instance 'yeti_snowplow-msg:location_point))
   (PID
    :reader PID
    :initarg :PID
    :type cl:boolean
...
(cl:defmethod cl:initialize-instance :after ((m <target>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'target)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name yeti_snowplow-msg:<target> is deprecated: use yeti_snowplow-msg:target instead.")))

(cl:ensure-generic-function 'dir-val :lambda-list '(m))
(cl:defmethod dir-val ((m <target>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yeti_snowplow-msg:dir-val is deprecated.  Use yeti_snowplow-msg:dir instead.")
  (dir m))

(cl:ensure-generic-function 'location-val :lambda-list '(m))
(cl:defmethod location-val ((m <target>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yeti_snowplow-msg:location-val is deprecated.  Use yeti_snowplow-msg:location instead.")
  (location m))

(cl:ensure-generic-function 'PID-val :lambda-list '(m))
(cl:defmethod PID-val ((m <target>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yeti_snowplow-msg:PID-val is deprecated.  Use yeti_snowplow-msg:PID instead.")
  (PID m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <target>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yeti_snowplow-msg:speed-val is deprecated.  Use yeti_snowplow-msg:speed instead.")
  (speed m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<target>)))
  ...
  (cl:format cl:nil "int32 dir~%int32 FORWARD=1~%int32 BACKWARD=-1~%location_point location~%bool PID~%float64 speed~%================================================================================~%MSG: yeti_snowplow/location_point~%float64 x~%float64 y~%float64 distance~%float64 heading~%float64 correctedX~%float64 correctedY~%int32 id~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'target)))
  "Returns full string definition for message of type 'target"
  (cl:format cl:nil "int32 dir~%int32 FORWARD=1~%int32 BACKWARD=-1~%location_point location~%bool PID~%float64 speed~%================================================================================~%MSG: yeti_snowplow/location_point~%float64 x~%float64 y~%float64 distance~%float64 heading~%float64 correctedX~%float64 correctedY~%int32 id~%~%"))
