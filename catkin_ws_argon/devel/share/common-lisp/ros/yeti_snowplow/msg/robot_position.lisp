...
(cl:defmethod cl:initialize-instance :after ((m <robot_position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name yeti_snowplow-msg:<robot_position> is deprecated: use yeti_snowplow-msg:robot_position instead.")))
