...
(cl:defclass <obstacles> (roslisp-msg-protocol:ros-message)
  ((obstacles
    :reader obstacles
    :initarg :obstacles
    :type (cl:vector yeti_snowplow-msg:obstacle)
   :initform (cl:make-array 0 :element-type 'yeti_snowplow-msg:obstacle :initial-element (cl:make-instance 'yeti_snowplow-msg:obstacle))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <obstacles>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'obstacles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name yeti_snowplow-msg:<obstacles> is deprecated: use yeti_snowplow-msg:obstacles instead.")))

(cl:ensure-generic-function 'obstacles-val :lambda-list '(m))
(cl:defmethod obstacles-val ((m <obstacles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yeti_snowplow-msg:obstacles-val is deprecated.  Use yeti_snowplow-msg:obstacles instead.")
  (obstacles m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <obstacles>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'obstacles)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'yeti_snowplow-msg:obstacle))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<obstacles>)))
  ...
  (cl:format cl:nil "obstacle[] obstacles~%~%================================================================================~%MSG: yeti_snowplow/obstacle~%float32 x~%float32 y~%#x and y are relative to robot position and orientation~%float32 r~%#radius of obstacle~%bool dynamic~%#if object is or was previously moving, i.e. this is a new obstacle in this position~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'obstacles)))
  "Returns full string definition for message of type 'obstacles"
  (cl:format cl:nil "obstacle[] obstacles~%~%================================================================================~%MSG: yeti_snowplow/obstacle~%float32 x~%float32 y~%#x and y are relative to robot position and orientation~%float32 r~%#radius of obstacle~%bool dynamic~%#if object is or was previously moving, i.e. this is a new obstacle in this position~%~%~%"))
