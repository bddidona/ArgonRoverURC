...
(cl:defmethod cl:initialize-instance :after ((m <location_point>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'location_point)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rover_manual-msg:<location_point> is deprecated: use rover_manual-msg:location_point instead.")))
...
(cl:defmethod correctedX-val ((m <location_point>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_manual-msg:correctedX-val is deprecated.  Use rover_manual-msg:correctedX instead.")
  (correctedX m))

(cl:ensure-generic-function 'correctedY-val :lambda-list '(m))
(cl:defmethod correctedY-val ((m <location_point>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_manual-msg:correctedY-val is deprecated.  Use rover_manual-msg:correctedY instead.")
  (correctedY m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <location_point>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_manual-msg:id-val is deprecated.  Use rover_manual-msg:id instead.")
  (id m))
