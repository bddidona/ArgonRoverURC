...
;//! \htmlinclude vesc_state.msg.html

(cl:defclass <vesc_state> (roslisp-msg-protocol:ros-message)
  ((voltage_input
...
(cl:defclass vesc_state (<vesc_state>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <vesc_state>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'vesc_state)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rover_manual-msg:<vesc_state> is deprecated: use rover_manual-msg:vesc_state instead.")))

(cl:ensure-generic-function 'voltage_input-val :lambda-list '(m))
(cl:defmethod voltage_input-val ((m <vesc_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_manual-msg:voltage_input-val is deprecated.  Use rover_manual-msg:voltage_input instead.")
  (voltage_input m))

(cl:ensure-generic-function 'temperature_pcb-val :lambda-list '(m))
(cl:defmethod temperature_pcb-val ((m <vesc_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_manual-msg:temperature_pcb-val is deprecated.  Use rover_manual-msg:temperature_pcb instead.")
  (temperature_pcb m))

(cl:ensure-generic-function 'current_motor-val :lambda-list '(m))
(cl:defmethod current_motor-val ((m <vesc_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_manual-msg:current_motor-val is deprecated.  Use rover_manual-msg:current_motor instead.")
  (current_motor m))

(cl:ensure-generic-function 'current_input-val :lambda-list '(m))
(cl:defmethod current_input-val ((m <vesc_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_manual-msg:current_input-val is deprecated.  Use rover_manual-msg:current_input instead.")
  (current_input m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <vesc_state>))
...
(cl:defmethod duty_cycle-val ((m <vesc_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_manual-msg:duty_cycle-val is deprecated.  Use rover_manual-msg:duty_cycle instead.")
  (duty_cycle m))

(cl:ensure-generic-function 'charge_drawn-val :lambda-list '(m))
(cl:defmethod charge_drawn-val ((m <vesc_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_manual-msg:charge_drawn-val is deprecated.  Use rover_manual-msg:charge_drawn instead.")
  (charge_drawn m))

(cl:ensure-generic-function 'charge_regen-val :lambda-list '(m))
(cl:defmethod charge_regen-val ((m <vesc_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_manual-msg:charge_regen-val is deprecated.  Use rover_manual-msg:charge_regen instead.")
  (charge_regen m))

(cl:ensure-generic-function 'energy_drawn-val :lambda-list '(m))
(cl:defmethod energy_drawn-val ((m <vesc_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_manual-msg:energy_drawn-val is deprecated.  Use rover_manual-msg:energy_drawn instead.")
  (energy_drawn m))

(cl:ensure-generic-function 'energy_regen-val :lambda-list '(m))
(cl:defmethod energy_regen-val ((m <vesc_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_manual-msg:energy_regen-val is deprecated.  Use rover_manual-msg:energy_regen instead.")
  (energy_regen m))

(cl:ensure-generic-function 'displacement-val :lambda-list '(m))
(cl:defmethod displacement-val ((m <vesc_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_manual-msg:displacement-val is deprecated.  Use rover_manual-msg:displacement instead.")
  (displacement m))

(cl:ensure-generic-function 'distance_traveled-val :lambda-list '(m))
(cl:defmethod distance_traveled-val ((m <vesc_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_manual-msg:distance_traveled-val is deprecated.  Use rover_manual-msg:distance_traveled instead.")
  (distance_traveled m))

(cl:ensure-generic-function 'fault_code-val :lambda-list '(m))
(cl:defmethod fault_code-val ((m <vesc_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_manual-msg:fault_code-val is deprecated.  Use rover_manual-msg:fault_code instead.")
  (fault_code m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<vesc_state>)))
    "Constants for message type '<vesc_state>"
  '((:FAULT_CODE_NONE . 0)
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <vesc_state>) ostream)
  "Serializes a message object of type '<vesc_state>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <vesc_state>) istream)
  "Deserializes a message object of type '<vesc_state>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<vesc_state>)))
  "Returns string type for a message object of type '<vesc_state>"
  "rover_manual/vesc_state")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'vesc_state)))
  "Returns string type for a message object of type 'vesc_state"
  "rover_manual/vesc_state")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<vesc_state>)))
  "Returns md5sum for a message object of type '<vesc_state>"
  "81214bb4c1945e7c159bd76ec397ac04")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'vesc_state)))
  "Returns md5sum for a message object of type 'vesc_state"
  "81214bb4c1945e7c159bd76ec397ac04")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<vesc_state>)))
  "Returns full string definition for message of type '<vesc_state>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'vesc_state)))
  "Returns full string definition for message of type 'vesc_state"
  (cl:format cl:nil "# Vedder VESC open source motor controller state (telemetry)~%~%# fault codes~%int32 FAULT_CODE_NONE=0~%int32 FAULT_CODE_OVER_VOLTAGE=1~%int32 FAULT_CODE_UNDER_VOLTAGE=2~%int32 FAULT_CODE_DRV8302=3~%int32 FAULT_CODE_ABS_OVER_CURRENT=4~%int32 FAULT_CODE_OVER_TEMP_FET=5~%int32 FAULT_CODE_OVER_TEMP_MOTOR=6~%~%float64 voltage_input        # input voltage (volt)~%float64 temperature_pcb      # temperature of printed circuit board (degrees Celsius)~%float64 current_motor        # motor current (ampere)~%float64 current_input        # input current (ampere)~%float64 speed                # motor electrical speed (revolutions per minute) ~%float64 duty_cycle           # duty cycle (0 to 1)~%float64 charge_drawn         # electric charge drawn from input (ampere-hour)~%float64 charge_regen         # electric charge regenerated to input (ampere-hour)~%float64 energy_drawn         # energy drawn from input (watt-hour)~%float64 energy_regen         # energy regenerated to input (watt-hour)~%float64 displacement         # net tachometer (counts)~%float64 distance_traveled    # total tachnometer (counts)~%int32   fault_code~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <vesc_state>))
  (cl:+ 0
     8
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <vesc_state>))
