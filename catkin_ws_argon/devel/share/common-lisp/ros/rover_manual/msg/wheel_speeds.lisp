...
(cl:defmethod cl:initialize-instance :after ((m <wheel_speeds>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'wheel_speeds)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rover_manual-msg:<wheel_speeds> is deprecated: use rover_manual-msg:wheel_speeds instead.")))

(cl:ensure-generic-function 'left-val :lambda-list '(m))
(cl:defmethod left-val ((m <wheel_speeds>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_manual-msg:left-val is deprecated.  Use rover_manual-msg:left instead.")
  (left m))

(cl:ensure-generic-function 'right-val :lambda-list '(m))
(cl:defmethod right-val ((m <wheel_speeds>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rover_manual-msg:right-val is deprecated.  Use rover_manual-msg:right instead.")
  (right m))
