...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rover_manual' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ben/catkin/catkin_ws_argon/install/${idir}'.  Ask the maintainer 'Intelligent Systems Club, University of Michigan-Dearborn <isc-robotics@umich.edu>, Ben DiDonato <bddidona@umich.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ben/catkin/catkin_ws_argon/install/lib;/opt/ros/kinetic/lib)
